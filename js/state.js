        ...
        // Second obstacle slot — used exclusively by cluster events (side-by-side
        // or slalom pairs generated by the world difficulty system at 10 K+ score).
        // Shares the same collision/scoring logic as obstacle but is tracked
        // independently so both can be on the road simultaneously.
        const obstacle2 = {
            lane: 1,
            distance: 100,
            active: false,
        ...
        // <50, starts backfiring (single bang at 50%, clusters grow more likely as
        // health falls) + misfiring (pulse drop-outs) <25, everything exaggerated
        // <10. Helpers below feed the engine audio
        ...
        // Per-spawn pitch randomisation. Zero variance below 10 K; scales linearly
        // with difficulty tier to this ceiling at tier 10 (100 K+).
        const OBSTACLE_PITCH_MAX_SEMITONES = 2;
